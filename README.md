...
|주제|결과기록|URL|
|---|---|-|
|Learn_Basic| Numpy, Python 데이터 구조 파악 및 머신러닝 모델 별 작동원리 정리| [링크]([https://github.com/sinheechan/Data_Analysis_Titanic.git](https://github.com/sinheechan/Learn_Basic.git))|
